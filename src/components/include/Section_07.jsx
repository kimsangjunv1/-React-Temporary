...
return (
    ...
    <section id="project">
        {/* 내용 */}
        <section>
            <section className="section6p7_static">
                <p className="section6p7_title">TEAM <em>PROJECT</em></p>
            </section>

            <section className="light ir">light</section>

            <section>
                <div className="screenshot_cont">
                    <img className="screenshot s6p5_1" src={section7_screenshot_01_test} alt="" loading="lazy" />
                    <img className="screenshot s6p5_2" src={section6p5_screenshot_02} alt="" loading="lazy" />
                </div>
            ...
            <section>
                <img className="screenshot s6p5_10" src={section6p5_screenshot_07} alt="" loading="lazy" />
                <img className="screenshot s6p5_11" src={section6p5_screenshot_08} alt="" loading="lazy" />
