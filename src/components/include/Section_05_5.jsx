...
const Section_05_5 = () => {
  return (
    ...
    <section className="divider type-03">
      ...
      v44h-352z"
        ...
        <g className="parallax">
          <use xlinkHref="#gentle-wave" x="50" y="0" fill="#161c29" />
          <use xlinkHref="#gentle-wave" x="50" y="3" fill="#161c29cf" />
          <use xlinkHref="#gentle-wave" x="50" y="6" fill="#161c29ad" />
        </g>
      </svg>
